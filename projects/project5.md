...
**Here's a complete list of arithmetic identities that you should implement in** `optimize`:
...
Type: TBool
```
$$ (if): \frac{\Gamma \vdash e_1:Bool, \Gamma\vdash e_2:\tau,\Gamma\vdash e_3:\tau }{\Gamma \vdash if\space e_1\space then\space e_2\space else\space e_3:\tau} $$
